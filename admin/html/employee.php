...
if (isset ($_POST['add'])) {
   ...
   $q1 = "INSERT INTO `emp`(`name`, `dob`, `email`, `pass`, `phno`, `address`) VALUES ('$name','$dob','$email','$pass','$phone','$address')";
...
if (isset ($_POST['update'])) {
   ...
   $q1 = "UPDATE `emp` SET `name`='$name',`dob`='$dob',`email`='$email',`pass`='$pass',`phno`='$phone',`address`='$address' WHERE id = $_GET[edit]";
...
if (isset ($_GET['edit'])) {
   $select = "select * from emp where id=$_GET[edit]";
   $result = $con->query($select);
   $row = mysqli_fetch_array($result);
}

if (isset ($_GET['del'])) {
   $delete = "DELETE FROM `emp` WHERE id=$_GET[del]";
      ...
      <div class="layout-wrapper layout-content-navbar">
         <div class="layout-container">
            ...
            <div class="layout-page">
               <div>
                  <h2 class="text-uppercase text-primary fw-bolder text-center mt-5">Employee Data</h2>
               </div>
               <!-- ADD EMP -->
                     ...
                     <form id="employeeDataForm" method="POST" class="needs-validation">
                           ...
                           <div class="mb-3">
                              ...
                              <div class="input-group">
                                 ...
                                 <input type="date" class="form-control" name="dob" id="employeeAge" placeholder="Enter Date of Birth" required>
                           ...
                           <div class="mb-3">
                              ...
                              <div class="input-group">
                                 ...
                                 <input type="email" class="form-control" value="<?php if (isset ($_GET['edit']))
                                    echo $row['email']; ?>" name="email" id="employeeEmail" placeholder="Enter email" required>
                           ...
                           <div class="mb-3">
                              ...
                              <div class="input-group">
                                 ...
                                 <input type="tel" class="form-control" value="<?php if (isset ($_GET['edit']))
                                    echo $row['phno']; ?>" name="phone" id="employeePhone" placeholder="Enter phone number" required>
                              ...
                              <td>
                                 <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item text-warning" href="employee.php?edit=<?php echo $row['id'] ?>"><i class="bx bx-edit-alt me-2"></i>Edit</a>
                                       <a class="dropdown-item text-danger" href="employee.php?del=<?php echo $row['id'] ?>" onclick="return confirm('ARE YOU SURE TO DELETE?');"><i class="bx bx-trash me-2"></i>Delete</a>
                                    </div>
                                 </div>
                              </td>
                           </tr>
