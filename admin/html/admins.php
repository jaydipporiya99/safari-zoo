...
if (isset ($_POST['add'])) {
   ...
   $q1 = "INSERT INTO `admin`(`name`, `dob`, `email`, `pass`, `phno`, `address`) VALUES ('$name','$dob','$email','$pass','$phone','$address')";
...
if (isset ($_POST['update'])) {
   ...
   $q1 = "UPDATE `admin` SET `name`='$name',`dob`='$dob',`email`='$email',`pass`='$pass',`phno`='$phone',`address`='$address' WHERE id = $_GET[edit]";
...
if (isset ($_GET['edit'])) {
   $select = "select * from admin where id=$_GET[edit]";
   $result = $con->query($select);
   $row = mysqli_fetch_array($result);
}

if (isset ($_GET['del'])) {
   $delete = "DELETE FROM `admin` WHERE id=$_GET[del]";
   ...
   <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
         ...
         <div class="layout-page">
            <div>
               <h2 class="text-uppercase text-primary fw-bolder text-center mt-5">Admins Data</h2>
            </div>
            <!-- ADD EMP -->
                     ...
                     <div class="mb-3">
                        ...
                        <div class="input-group">
                           ...
                           <input type="tel" class="form-control" value="<?php if (isset ($_GET['edit']))
                              echo $row['phno']; ?>" name="phone" id="employeePhone" placeholder="Enter phone number"
                              required>
                              ...
                              <div class="dropdown">
                                 ...
                                 <div class="dropdown-menu">
                                    <a class="dropdown-item text-warning"
                                       href="admins.php?edit=<?php echo $row['id'] ?>"><i
                                          class="bx bx-edit-alt me-2"></i>Edit</a>
                                    <a class="dropdown-item text-danger"
                                       href="admins.php?del=<?php echo $row['id'] ?>"
