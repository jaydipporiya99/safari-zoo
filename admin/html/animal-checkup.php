   ...
   <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
         ...
         <div class="layout-page">
            <div>
               <h2 class="text-uppercase text-primary fw-bolder text-center mt-5">CheckUp Data</h2>
            </div>
            <!-- ADD ANIMAL -->
            <!-- ---------------------------------------------------------------------------------------------- -->
                        ...
                        ?>
                                 ...
                                 <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                       ...
                                       <li class="nav-item">
                                          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                             data-bs-target="#navs-top-elimi<?php echo $row['id']; ?>" aria-controls="navs-top-primary"
                                             aria-selected="false">
                                             Eliminations
                                          </button>
                                       </li>
                                    ...
                                    <div class="tab-content">
                                       ...
                                       <div class="tab-pane fade" id="navs-top-general<?php echo $row['id']; ?>" role="tabpanel">
                                          <div class="row">
                                             <div class="col-md-6">
                                                <h5 class="primary-text text-primary">
                                                   Sex:
                                       ...
                                       <div class="tab-pane fade" id="navs-top-elimi<?php echo $row['id']; ?>" role="tabpanel">
                                          <h5>Urine Frequency: <span class="fw-bold text-primary">
                                                <?php echo $row['urineFrequency']; ?>
                                             </span></h5>
                                          <h5>Urine Consistency: <span class="fw-bold text-primary">
                                                <?php echo $row['urineConsistency']; ?>
                                             </span></h5>
                                          <h5>Urine Color: <span class="fw-bold text-primary">
                                       ...
                                       <div class="tab-pane fade" id="navs-top-behave<?php echo $row['id']; ?>" role="tabpanel">
                                          <h5>
                                             Activity Level:<span class="fw-bold text-primary">
                                                <?php echo $row['activityLevel']; ?>
                                             </span>
                                          </h5>
                                          <h5>
                                             Behavior Description:<span class="fw-bold text-primary">
                                       ...
                                       <div class="tab-pane fade" id="navs-top-vacci<?php echo $row['id']; ?>" role="tabpanel">
                                          <h5>
                                             Vaccination Name:<span class="fw-bold text-primary">
                                                <?php echo $row['vaccinationName']; ?>
                                             </span>
                                          </h5>
                                          <h5>
                                             Vaccination Date:<span class="fw-bold text-primary">
