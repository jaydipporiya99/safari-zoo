...
<body class="background--dark">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-10 text-center"> <!-- Centering content -->
                            <h4 class="elements__title color--white">Pay Donation</h4>
                        </div>
                    </div>
                    <div class="row">
    ...
    var options = {
        ...
        "amount": <?php echo $_SESSION['sesAmt'] * 100; ?>, // Initial amount
            "currency": "INR",
            "name": "SAFARI",
            ...
            "handler": function (response) {
                // Handle response
                // Update amount based on response if needed
                window.location.href = "donation-mail.php";
            }
        };
