...
<body>
	<div class="page-wrapper">
		...
		<main class="main">
			<!-- promo start-->
			<section class="promo promo--front-6">
				<div class="promo-slider">
					<div class="promo-slider__item promo-slider__item--style-2">
						<picture>
							<source srcset="img/shop-promo_1.jpg" media="(min-width: 992px)" />
							<img class="img--bg" src="img/shop-promo_1.jpg" alt="img" />
						</picture>
						<div class="container">
							<div class="row">
										...
										<div class="align-container__item">
											<div class="promo-slider__wrapper-1">
												<h2 class="promo-slider__title">
													<span>The Greatest Zoo</span><br />
													<span>with Shop</span>
												</h2>
											</div>
											<div class="promo-slider__wrapper-2">
												<p class="promo-slider__subtitle">
													Find the perfect memento to cherish your visit forever, from adorable plushies to handcrafted keepsakes inspired by your
													favorite creatures.
												</p>
											</div>
											<div class="promo-slider__wrapper-3">
												<a class="button promo-slider__button button--primary"
													href="shop-catalog.php">Discover</a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="promo-slider__item promo-slider__item--style-2 color--primary">
						<picture>
							<source srcset="img/shop-promo_2.jpg" media="(min-width: 992px)" />
							<img class="img--bg" src="img/shop-promo_2.jpg" alt="img" />
						</picture>
						<div class="container">
							<div class="row">
								<div class="col-lg-8 col-xl-7">
									<div class="align-container">
										<div class="align-container__item">
											<div class="promo-slider__wrapper-1">
												<h2 class="promo-slider__title">
													<span>You will find all the</span><br /><span>Best offers</span>
												</h2>
											</div>
											<div class="promo-slider__wrapper-2">
												<p class="promo-slider__subtitle color--primary">
													Take home a piece of the zoo at the BEST PRICES! <br>Shop our wide selection of souvenirs.
												</p>
											</div>
											<div class="promo-slider__wrapper-3">
												<a class="button promo-slider__button button--primary border--white"
													href="shop-catalog.php">Discover</a>
											</div>
										</div>
									</div>
					...
					<div class="row offset-margin">
						<div class="col-6 col-lg-3">
							<div class="icon-item text-center">
								<div class="icon-item__icon size-60">
									<svg class="icon">
										<use xlink:href="#lock"></use>
									</svg>
								</div>
								<h6 class="icon-item__title no-margin-bottom">
									High Security
								</h6>
							</div>
						</div>
						...
						<div class="col-6 col-lg-3">
							<div class="icon-item text-center">
								...
								<h6 class="icon-item__title no-margin-bottom">PayPass</h6>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row bottom-50">
						<div class="col-12">
							<div class="heading heading--primary heading--style-2">
								<span class="heading__pre-title">Category</span>
								<h2 class="heading__title no-margin-bottom">
									<span>Awesome Zoo Shop</span> <span>Categories</span>
								</h2>
							</div>
						</div>
					</div>
				...
				<div class="row offset-margin">
					<div class="col-sm-6 col-lg-4">
						<div class="categorie-item">
							<img class="img--bg" src="img/category_1.jpg" alt="img" />
							<div class="categorie-item__details">
								<span class="categorie-item__pretitle">Good Quality</span>
								<h4 class="categorie-item__title">Clothes</h4>
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-lg-4">
						<div class="categorie-item">
							<img class="img--bg" src="img/category_2.jpg" alt="img" />
							<div class="categorie-item__details">
								<span class="categorie-item__pretitle">Useful</span>
								<h4 class="categorie-item__title">Accessories</h4>
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-lg-4">
						<div class="categorie-item">
							<img class="img--bg" src="img/category_3.jpg" alt="img" />
							<div class="categorie-item__details">
								<span class="categorie-item__pretitle">Special</span>
								<h4 class="categorie-item__title">Kids Toys</h4>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="section">
				<div class="container">
					<div class="row bottom-50">
						<div class="col-12">
							<div class="heading heading--primary heading--style-2">
								<span class="heading__pre-title">product</span>
								<h2 class="heading__title no-margin-bottom">
									<span>New</span> <span>products</span>
								</h2>
							</div>
						</div>
					</div>
					<div class="row offset-30">
						<?php 
								$select = "SELECT * FROM products ORDER BY id DESC LIMIT 6;";
						...
						<div class="col-sm-6 col-xl-4">
							<div class="shop-item shop-item--style-2">
								<div class="row align-items-center">
									<div class="col-lg-6">
										<div class="shop-item__img">
											<a
												class="shop-item__add" href="shop-product.php?id=<?php echo $row['id']; ?>">
												<span>VIEW</span>
											</a>
											<img class="img--contain"
												src="./img/product/<?PHP echo $row['img1']; ?>" alt="img" />
										</div>
									</div>
									<div class="col-lg-6">
										<div class="shop-item__details">
											...
											<div class="shop-item__details-lower">
												<span class="shop-item__sale">
													<s class="shop-item__price-old"><?PHP echo $row['old_price']; ?>₹</s><span
														class="shop-item__price"><?PHP echo $row['new_price']; ?>₹</span></span>
														<br>
												<span class="color--primary fw-bold"><?PHP echo $row['category']; ?></span>
											</div>
										</div>
									</div>
								</div>
			...
			<section class="section banner">
				<img class="img--bg" src="img/banner-bg.jpg" alt="img" /><img class="banner__img"
					src="img/banner-img.png" alt="img" />
				<div class="container">
					<div class="row">
						<div class="col-xl-6">
							<div class="heading heading--primary heading--style-2">
								<span class="heading__pre-title">Shop</span>
								<h2 class="heading__title color--white">
									<mark>50 % Profit</mark> <span>goes to Animal </span>
								</h2>
								<p class="color--white">
									Explore our range of accessories, each purchase contributes to a noble cause. Fifty percent of all profits from this collection will be dedicated to supporting animal welfare initiatives. Shop guilt-free knowing that your purchase helps make a difference in the lives of animals in need.
								</p>
								<a class="button button--primary" href="shop-catalog.php">Discover</a>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="col-md-7">
									<div class="heading heading--primary">
										...
										<h2 class="heading__title">
											<span>People</span> <span>Says</span>
										</h2>
									</div>
								</div>
								<div class="col-md-5">
									<div class="testimonials--style-2__dots text-md-right"></div>
								</div>
							</div>
							<div class="row">
								<div class="col-12">
									<div class="testimonials-slider testimonials-slider--style-2">
										<div class="testimonials-slider__item">
											<div class="testimonials-slider__text">
												<p>
													At Green Eco Tours, we're committed to promoting sustainable tourism practices. That's why we were so impressed with
													Safari's dedication to animal welfare and habitat conservation. Their seamless facilities are not only
													convenient for visitors, but they're also designed with the animals' well-being in mind.
												</p>
											</div>
											<div class="testimonials-slider__details">
												<span class="testimonials-slider__name">Ravi Kumar, </span><span
													class="testimonials-slider__position">Director of Sustainability, Green Eco Tours</span>
											</div>
										</div>
										<div class="testimonials-slider__item">
											<div class="testimonials-slider__text">
												<p>
													As a wildlife biologist, I was eager to experience Safari firsthand. I was thoroughly impressed by the
													seamless design of the facilities. The unobtrusive viewing areas allowed for exceptional observation of the animals
													without causing any disruption to their natural behavior.
												</p>
											</div>
											<div class="testimonials-slider__details">
												<span class="testimonials-slider__name">Dr. Neha Sharma, </span><span
													class="testimonials-slider__position">Professor of Wildlife Biology</span>
											</div>
										</div>
										<div class="testimonials-slider__item">
											<div class="testimonials-slider__text">
												<p>
													At Adventure Treks, we specialize in crafting immersive travel experiences that connect people with nature. Recently, we
													partnered with Safari to offer a unique safari adventure, and it exceeded our expectations! Our clients were
													blown away by the seamless facilities.
												</p>
											</div>
											<div class="testimonials-slider__details">
												<span class="testimonials-slider__name">John Maclein, </span><span
													class="testimonials-slider__position">CEO, Adventure Treks</span>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="row bottom-50">
						<div class="col-12">
							<div class="heading heading--primary heading--center">
								<span class="heading__pre-title">Our partners</span>
								<h2 class="heading__title no-margin-bottom">
									<span>People Who</span> <span>Trust Us</span>
								</h2>
							</div>
						</div>
					</div>
