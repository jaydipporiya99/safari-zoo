...
<body class="background--dark">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-10 text-center"> <!-- Centering content -->
                            <h4 class="elements__title color--white">Pay Tickets</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-8 text-center"> <!-- Centering content -->
                            <button class="button button--primary form__submit color--orange" type="submit" id="payment">PAY</button>
                        </div>
                    </div>
                </div>
            </section>
    ...
    var options = {
        ...
        "amount": <?php echo $_SESSION['totalTicket'] * 100; ?>, // Initial amount
            "currency": "INR",
            "name": "SAFARI",
            "description": "Zoo Ticket Booking",
            "image": "img/slogo.svg",
            "handler": function (response) {
                window.location.href = "email-ticket.php";
            }
        };
