(function ($) {
	...
	$(document).ready(function () {
		...
		// 		$input.val(count);
		// 		$input.change();
		// 		updateSumma($input); // Call the function to update the summa value
		// 		return false;
		// 	});
		...
		// 	// Function to update the summa value
		// 	function updateSumma(inputField) {
		// 		var price = parseFloat(inputField.closest('.cart-item').find('.cart-item__price span:first-child').text());
		// 		var count = parseInt(inputField.val());
		// 		var summa = price * count;
		// 		inputField.closest('.cart-item').find('.cart-item__summa span:first-child').text(summa.toFixed(2));
		// 	}
		// }

		// quantity(); // Call the function to initialize the counter functionality
